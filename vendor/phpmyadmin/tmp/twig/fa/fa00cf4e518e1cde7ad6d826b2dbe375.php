...
echo _gettext("Exporting a raw query");
  ...
  ";
    ...
    {
        return new Source("", "table/export/index.twig", "/home/codeinnr/public_html/subdomain/profihairshop.cdin.ro/vendor/phpmyadmin/templates/table/export/index.twig");
    }
}
