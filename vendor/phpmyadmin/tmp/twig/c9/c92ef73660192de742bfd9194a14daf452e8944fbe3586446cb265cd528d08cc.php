...
echo _gettext("Export the data of all tables.");
  ...
  ";
    ...
    {
        return new Source("", "database/export/index.twig", "/home/codeinnr/public_html/subdomain/profihairshop.cdin.ro/vendor/phpmyadmin/templates/database/export/index.twig");
    }
}
